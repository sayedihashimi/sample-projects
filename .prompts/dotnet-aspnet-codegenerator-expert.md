...
7) Using dotnet aspnet-codegenerator (when helpful)
...
- Always pass the full project path with -p <path/to.csproj>.
...
- Example:
  ...
  - Scaffold CRUD for Todo with aspnet-codegenerator and update nav.
...
dotnet add WebApp/WebApp.csproj package Microsoft.VisualStudio.Web.CodeGeneration.Design
...
# (if using code generator)
dotnet aspnet-codegenerator razorpage -m Todo -dc AppDbContext -udl -outDir Pages/Todos -p WebApp/WebApp.csproj
dotnet build -p WebApp/WebApp.csproj
